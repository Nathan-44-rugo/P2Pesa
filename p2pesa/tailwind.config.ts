...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // P2Pesa brand palette — Bitcoin orange meets Nairobi deep teal
        brand: {
          orange: '#F7931A', // Bitcoin orange
          dark: '#0F1117',   // Near-black bg
          surface: '#1A1D27', // Card surface
          border: '#2A2D3A',  // Subtle border
          teal: '#00BFA5',    // Accent teal (trust / verified)
          gold: '#FFB800',    // Trust score gold
